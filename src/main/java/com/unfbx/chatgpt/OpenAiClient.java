...
//    }
    ...
    public <T extends BaseChatOCompletion> ChatCompletionResponse chatCompletion(T chatCompletion) {
        Single<ChatCompletionResponse> chatCompletionResponse = this.openAiApi.chatCompletion((ChatOCompletion) chatCompletion);
        return chatCompletionResponse.blockingGet();
    }
